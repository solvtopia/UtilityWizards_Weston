    ...
    Public Function Save(ByVal xmlData As String) As SystemClient
        ...
        Try
            If Me.ID = 0 Then
                ...
                Dim cmd As New SqlClient.SqlCommand("INSERT INTO [Clients] ([xmlData], [dtInserted], [dtUpdated], [insertedBy], [updatedBy]) VALUES (@xmlData, '" & Now.ToString & "', '" & Now.ToString & "', '" & App.CurrentUser.ID & "', '" & App.CurrentUser.ID & "');SELECT @@Identity AS SCOPEIDENTITY;", cn)
                If xmlData = "" Then
                    cmd.Parameters.AddWithValue("@xmlData", Me.SerializeToXml)
                Else cmd.Parameters.AddWithValue("@xmlData", xmlData)
                End If
                ...
                cmd.Cancel()
            Else
                Dim cmd As New SqlClient.SqlCommand("UPDATE [Clients] SET [xmlData] = @xmlData, [dtUpdated] = '" & Now.ToString & "', [updatedBy] = " & App.CurrentUser.ID & " WHERE [ID] = " & Me.ID, cn)
                If xmlData = "" Then
                    cmd.Parameters.AddWithValue("@xmlData", Me.SerializeToXml)
                Else cmd.Parameters.AddWithValue("@xmlData", xmlData)
                End If
...
#Region "Workers"
    ...
    Public Function Save(ByVal xmlData As String) As SystemModule
        ...
        Try
            If Me.ID = 0 Then
                Dim cmd As New SqlClient.SqlCommand("INSERT INTO [Modules] ([xmlData], [dtInserted], [dtUpdated], [insertedBy], [updatedBy], [Active]) VALUES (@xmlData, '" & Now.ToString & "', '" & Now.ToString & "', '" & App.CurrentUser.ID & "', '" & App.CurrentUser.ID & "', '1');SELECT @@Identity AS SCOPEIDENTITY;", cn)
                If xmlData = "" Then
                    cmd.Parameters.AddWithValue("@xmlData", Me.SerializeToXml)
                Else cmd.Parameters.AddWithValue("@xmlData", xmlData)
                End If
                ...
                cmd.Cancel()
            Else
                Dim cmd As New SqlClient.SqlCommand("UPDATE [Modules] SET [xmlData] = @xmlData, [dtUpdated] = '" & Now.ToString & "', [updatedBy] = " & App.CurrentUser.ID & " WHERE [ID] = " & Me.ID, cn)
                If xmlData = "" Then
                    cmd.Parameters.AddWithValue("@xmlData", Me.SerializeToXml)
                Else cmd.Parameters.AddWithValue("@xmlData", xmlData)
                End If
...
#Region "Workers"
    ...
    Public Function Save(ByVal xmlData As String) As SystemQuestion
        ...
        Try
            If Me.ID = 0 Then
                Dim cmd As New SqlClient.SqlCommand("INSERT INTO [Questions] ([xmlData], [dtInserted], [dtUpdated], [insertedBy], [updatedBy], [Active]) VALUES (@xmlData, '" & Now.ToString & "', '" & Now.ToString & "', '" & App.CurrentUser.ID & "', '" & App.CurrentUser.ID & "', '1');SELECT @@Identity AS SCOPEIDENTITY;", cn)
                If xmlData = "" Then
                    cmd.Parameters.AddWithValue("@xmlData", Me.SerializeToXml)
                Else cmd.Parameters.AddWithValue("@xmlData", xmlData)
                End If
                ...
                cmd.Cancel()
            Else
                Dim cmd As New SqlClient.SqlCommand("UPDATE [Questions] SET [xmlData] = @xmlData, [dtUpdated] = '" & Now.ToString & "', [updatedBy] = " & App.CurrentUser.ID & " WHERE [ID] = " & Me.ID, cn)
                If xmlData = "" Then
                    cmd.Parameters.AddWithValue("@xmlData", Me.SerializeToXml)
                Else cmd.Parameters.AddWithValue("@xmlData", xmlData)
                End If
    ...
    Public Function Delete() As Boolean
        ...
        Try
            Dim cmd As New SqlClient.SqlCommand("UPDATE [Questions] SET [xmlData] = @xmlData, [Active] = 0, [dtUpdated] = '" & Now.ToString & "', [updatedBy] = " & App.CurrentUser.ID & " WHERE [ID] = " & Me.ID, cn)
            cmd.Parameters.AddWithValue("@xmlData", Me.SerializeToXml)
            If cmd.Connection.State = ConnectionState.Closed Then cmd.Connection.Open()
            cmd.ExecuteNonQuery()
